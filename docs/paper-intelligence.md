...
- [Paper-83 战役](paper-83-campaign.md) — 冻结名单、membership hash，以及三个不同 "83" 数字的定义。
- [训练就绪流水线](training-readiness.md) — 从 implementation ready 到训练门的六道关卡。
- [能力成熟度](capability-maturity.md) — 组件侧成熟度阶梯。
