...
- **Error-delta 下一轮决策**：`yolo_agent/agents/loop_evidence.py`, `yolo_agent/agents/policy_stage_runner.py`, `yolo_agent/core/detection_error_delta.py`, `yolo_agent/core/error_root_cause.py`, `yolo_agent/core/error_decision_trace.py`, `yolo_agent/core/error_round_artifacts.py`, `yolo_agent/core/error_capability_promotion.py`
