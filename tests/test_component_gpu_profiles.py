    ...
    evidence = AssignmentShadowEvidence.model_validate(
        {
            ...
            "native_audit": {
                ...
                "resources": {
                    "samples": 1,
                    "native_latency_ms_total": 0.5,
                    "candidate_latency_ms_total": 0.75,
                    "candidate_latency_ms_max": 0.75,
                    "incremental_memory_mb_max": 1.0,
                    "maximum_assignment_latency_ms": 2.0,
                    "maximum_incremental_memory_mb": 16.0,
