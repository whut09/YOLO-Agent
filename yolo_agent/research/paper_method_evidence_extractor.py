...
_RULES: tuple[_Rule, ...] = (
    ...
    _Rule("insertion_point", "trainer_loss", (r"\b(?:selects?|mines?|weights?) difficult losses\b", r"\bonline hard example mining\b")),
    ...
    _Rule("insertion_point", "inference_policy", (r"\bpost[- ]hoc calibration\b", r"\btemperature scaling\b",)),
    ...
    _Rule("changed_variable", "inference.calibration.method", (r"\bpost[- ]hoc calibration\b", r"\btemperature scaling\b",)),
    ...
    _Rule("inference_changed", True, (r"\bpost[- ]hoc calibration\b", r"\btemperature scaling\b",)),
